package com.network.engine.protal.tcp.bean;
...
public class TcpMsg {
    ...
    public TcpMsg(byte[] data, TcpServerInfo target, MsgType type) {
    ...
    public TcpMsg(String data, TcpServerInfo target, MsgType type) {
        this.target = target;
    ...
    public TcpServerInfo getTarget() {
        return target;
    }

    public void setTarget(TcpServerInfo target) {
        this.target = target;
    }
}
